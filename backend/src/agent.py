...
print("\n" + "🎯" * 50)
print("🚀 COFFEE SHOP AGENT - BY AMLAN DEY")
print("📚 Place your coffee orders with AI")
...
async def complete_order(ctx: RunContext[Userdata]) -> str:
    ...
    try:
        ...
        print("Made with ❤️ by AI Barista")
        print("⭐" * 60 + "\n")
...
class BaristaAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions="""
            🏪 You are a FRIENDLY and PROFESSIONAL barista at "Amlan Dey's Cafe".
...
async def entrypoint(ctx: JobContext):
    ...
    print("\n" + "🏪" * 25)
    print("🚀 AD's CAFE - AI BARISTA")
    print("Made with ❤️ by Amlan Dey")
    print("☕ Place your coffee orders with AI")
...
if __name__ == "__main__":
    ...
    print("👨‍⚕️ Developed by Amlan Dey")
    print("☕ Place your coffee orders with AI")
    print("⚡" * 25 + "\n")
