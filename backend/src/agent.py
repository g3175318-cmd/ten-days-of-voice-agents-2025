...
print("\n" + "💼" * 50)
print("🚀 AI SDR AGENT")
print("📚 SELLING: Amlan Dey's Cloud & AI Courses")
...
# Default FAQ data for "Amlan Dey's Store"
DEFAULT_FAQ = [
    {
...
class SDRAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions=f"""
            You are 'Sarah', a friendly and professional Sales Development Rep (SDR) for 'Amlan Dey's Store'.
            ...
            🚫 **RESTRICTIONS:**
            - If you don't know an answer, say "I'll check with Amlan Dey and email you." (Don't hallucinate prices).
            """,
